...
int main(int argc, char *argv[])
{
  ...
  18:	85450513          	addi	a0,a0,-1964 # 868 <malloc+0x11e>
  1c:	00000097          	auipc	ra,0x0
  20:	670080e7          	jalr	1648(ra) # 68c <printf>
        printf("Try 'sleep [time]'\n");
  24:	00001517          	auipc	a0,0x1
  28:	82c50513          	addi	a0,a0,-2004 # 850 <malloc+0x106>
  2c:	00000097          	auipc	ra,0x0
  30:	660080e7          	jalr	1632(ra) # 68c <printf>
        exit(0);
  34:	4501                	li	a0,0
  36:	00000097          	auipc	ra,0x0
  3a:	2de080e7          	jalr	734(ra) # 314 <exit>
        printf("sleep: missing time parameter\n");
  3e:	00000517          	auipc	a0,0x0
  42:	7f250513          	addi	a0,a0,2034 # 830 <malloc+0xe6>
  46:	00000097          	auipc	ra,0x0
  4a:	646080e7          	jalr	1606(ra) # 68c <printf>
        printf("Try 'sleep [time]'\n");
  4e:	00001517          	auipc	a0,0x1
  52:	80250513          	addi	a0,a0,-2046 # 850 <malloc+0x106>
  56:	00000097          	auipc	ra,0x0
  5a:	636080e7          	jalr	1590(ra) # 68c <printf>
        exit(0);
  5e:	4501                	li	a0,0
  60:	00000097          	auipc	ra,0x0
  64:	2b4080e7          	jalr	692(ra) # 314 <exit>
    }

    int time = atoi(argv[1]);
  68:	6588                	ld	a0,8(a1)
  6a:	00000097          	auipc	ra,0x0
  6e:	1aa080e7          	jalr	426(ra) # 214 <atoi>
    sleep(time);
  72:	00000097          	auipc	ra,0x0
  76:	332080e7          	jalr	818(ra) # 3a4 <sleep>
    exit(0);
  7a:	4501                	li	a0,0
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4c8:	3ccb8b93          	addi	s7,s7,972 # 890 <digits>
 ...
 608:	28490913          	addi	s2,s2,644 # 888 <malloc+0x13e>
        while(*s != 0){
